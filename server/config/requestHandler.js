...
var getFirstValidMatch = function(username, matchRequestsArray, userLocation) {
  var validMatch;
  var lat1 = parseInt(userLocation.latitude);
  var lon1 = parseInt(userLocation.longitude);
  ...
  for (var i = 0; i < matchRequestsArray.length; i++) {
    var lat2 = parseInt(matchRequestsArray[i].latitude);
    var lon2 = parseInt(matchRequestsArray[i].longitude);
